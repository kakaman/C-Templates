...
void heap_modify_element(heap_t* heap, void const* data, void const* element, int* map); // If you have to find.
void heap_modify_element_at(heap_t* heap, void const* data, int location, int* map); // If you know location.
